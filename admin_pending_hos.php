                    ...
                    if($total_pending_hospital  > 0){
                      while($pending_hospital_data = mysqli_fetch_assoc($fetch_pending_hospital)){ 
                        $i+=1;
                          ...
                          <td>pending</td>
                          <td><a  href="admin_accept_hospital.php?hospital_ID='.$pending_hospital_data['hospital_id'].'&pageUrl=admin_pending_hos.php" class="badge bg-success ">approved</a></td>
                          <td><a  href="admin_reject_hospital.php?hospital_ID='.$pending_hospital_data['hospital_id'].'&pageUrl=admin_pending_hos.php" class="badge bg-danger ">reject</a></td>
                        </tr>';
                        }
