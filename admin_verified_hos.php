          ...
          <div class="row ">
            ...
            <div class="col-xxl-4 col-md-6  w-100">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                <h5 class="card-title"> verified or not verified Hospital</h5>
                    ...
                    if($total_app_hospital  > 0){
                      while($app_hos_data = mysqli_fetch_assoc($fetch_app_hospital)){ 
                        ...
                        // if($app_hos_data['hospital_status'] == 'approved'){
                          ...
                          <td scope="row"><a href="#">'.$app_hos_data['reg_hos_id'].'</a></td>
                        ...
                        <td>'.$app_hos_data['hospital_close_time'].'</td>
                          <td>'.$app_hos_data['hospital_verified'].'</td>
                          <td><a  href="admin_reject_hospital.php?hospital_ID='.$app_hos_data['reg_hos_id'].'&pageUrl=admin_verified_hos.php" class="badge bg-danger ">reject</a></td>
