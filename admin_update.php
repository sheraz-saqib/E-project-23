...
echo $admin_edit_submit . "<br>";
    if(isset($admin_edit_submit)){
      ...
      if($admin_name_edit !='' && $admin_email_edit !='' &&  $admin_cnic_edit !='' && $admin_phone_edit !=''){
        $admin_updateQ = "UPDATE `admin` SET `admin_id`='$admin_id',`admin_name`='$admin_name_edit',`admin_email`='$admin_email_edit',`admin_cnic`='$admin_cnic_edit',`admin_phone`='$admin_phone_edit' WHERE `id`=$admin_id";
        ...
        $admin_data['admin_id'] = $_SESSION['admin_id'];
        $admin_data['admin_name'] = $_SESSION['admin_name'];
        $admin_data['admin_cnic'] = $_SESSION['admin_cnic'];
        $admin_data['admin_email'] = $_SESSION['admin_email'];
        $admin_data['admin_phone'] = $_SESSION['admin_phone'];
