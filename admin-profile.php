...
<?php require './component/_admin_nav.php';?>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?=$_SESSION['admin_cnic']?></div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8"><?=$_SESSION['admin_phone']?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8"><?=$_SESSION['admin_email']?></div>
                  </div>
  ...
  // ?>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input value="<?=$_SESSION['admin_name']?>" name="admin_name_edit" type="text" class="form-control" id="fullName" value="Kevin Anderson">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input value="<?=$_SESSION['admin_cnic']?>" name="admin_cnic_edit" type="text" class="form-control" id="company" value="Lueilwitz, Wisoky and Leuschke">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input value="<?=$_SESSION['admin_email']?>" name="admin_email_edit" type="text" class="form-control" id="Job" value="Web Designer">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input value="<?=$_SESSION['admin_phone']?>" name="admin_phone_edit" type="text" class="form-control" id="Country" value="USA">
                      </div>
                    </div>
                    ...
                    <input class="btn w-100" name="admin_edit_submit" type="submit" value="Save">
                    </div>
