          ...
          <div class="row ">
            ...
            <div class="col-xxl-4 col-md-6  w-50">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Today Appointment Patient </h5>
...
if($app_patient_data['pateint_dos_1'] == 'not vaccinated'){
    ...
    <td>'.$app_patient_data['pateint_dos_2'].'</td>
    <td>'.$app_patient_data['pateint_dos_2_date'].'</td>
    <td><a  href="admin_reject_pateint.php?patient_ID='.$app_patient_data['reg_pateint_id'].'&pageUrl=admin_today_pat.php" class="badge bg-danger ">reject</a></td>
